...
--view
  ...
  select o.order_id,o.pro_id,o.quantity,o.price,o.discount,c.cus_name from Order_Details o join Orders b on o.order_id=b.order_id join Customers c on c.cus_id=b.cus_id
