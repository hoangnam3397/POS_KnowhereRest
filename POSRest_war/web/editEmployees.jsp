         ...
         <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
               <ul class="nav navbar-nav">
                 ...
                 <li class="flat-box"><a href="GetTopProductServlet"><i class="fa fa-cogs"></i> <span class="menu-text">Setting</span></a></li>                 <li class="flat-box"><a href="http://www.dar-elweb.com/demos/zarest/stats"><i class="fa fa-line-chart"></i> <span class="menu-text">Reports</span></a></li>                                </ul>
   ...
   <div class="row" style="margin-top:100px;">
      ...
      <form action="editEmployeesServlet" method="post">      
        <div class="form-group">
         ...
         <input type="text" name="empname" value="${empName}" maxlength="25" Required class="form-control" id="empname" placeholder="Name">
        </div>
        <div class="form-group">
         <label for="Category">Roles</label>
         <select class="form-control" value="Juices" name="cate" id="Category">
                           <c:forEach var="e" items="${list}">
                                <c:if test="${e.roleId==cateid}">
