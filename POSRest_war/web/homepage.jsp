...
<html lang="en">
    ...
    <body>
        <!-- Navigation -->
        <%
            if (session.getAttribute("loginRole").equals("R001")) {
        %>
        ...
        <%
            }if (session.getAttribute("loginRole").equals("R003")) {
        %>
                    ...
                    <ul id="storeline">
                        <a href="getTableOfZoneFromStore?storeid=${store.stoId}">
                            <li class="listing clearfix">
                                ...
                                <div class="info">
                                    <span class="store_title">${store.stoName}</span>
                                    <span class="store_info">${store.address} <span>&bull;</span> ${store.phonesto}</span>
                                </div>
                                <span class="store_type store_open"><fmt:message key="admin.homepage.storeopen"/></span>
                            </li>
                        </a>
