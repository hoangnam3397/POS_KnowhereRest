    ...
    <div class="container container-small">
        <div class="row" style="margin-top:100px;">
            <a class="btn btn-default float-right" href="#" onclick="history.back(-1)"style="margin-bottom:10px;">
                <i class="fa fa-arrow-left"></i><fmt:message key="admin.editStore.button.back"/></a>
            <form action="editStoreServlet" method="post">      
                <div class="form-group">
                    <label for="StoreName"><fmt:message key="admin.editStore.button.name"/></label>
                    <input type="text" name="sto_name" value="${stoName}" maxlength="50" Required class="form-control" id="sto_name" placeholder="Name">
                </div>        
                <div class="form-group">
