            ...
            <div class="container container-small">
                <div class="row" style="margin-top:100px;">
                    <a class="btn btn-default float-right" href="getCustomerServlet" onclick="history.back(-1)"style="margin-bottom:10px;">
                        <i class="fa fa-arrow-left"></i><fmt:message key="admin.insertCus.button.back"/></a>
                <form id="insertCus-form" action="insertCustomerServlet" method="post" >      
                    <div class="form-group">
                        <label for="cus_name"><fmt:message key="admin.insertCus.text.cusname"/><a style="color:red">*</a></label>
                    ...
                    <div class="form-group" id="pushaceP">
                        <label for="email"><fmt:message key="admin.insertCus.text.email"/><a style="color:red">*</a></label>
                    ...
                    <div class="form-group">
                        <label for="Phone"><fmt:message key="admin.insertCus.text.phone"/><a style="color:red">*</a></label>
                        <input type="number" name="phone" maxlength="15" minlength="10" class="form-control" id="phone" placeholder="Phone">
                    </div>
                    <div class="form-group">
                        <label for="discount"><fmt:message key="admin.insertCus.text.dis"/> (%)<a style="color:red">*</a></label>
                        <input type="number" name="discount" max="15" min="0" maxlength="2" value="" class="form-control" id="Discount" placeholder="discount (%)">
                    </div>
                    <div class="form-group">
                        <button type="submit" name="action" value="Submit" class="btn btn-green col-md-6 flat-box-btn"><fmt:message key="admin.insertCus.button.submit"/></button>
                    </div>
                </form>
                    <br>
                    <br>
