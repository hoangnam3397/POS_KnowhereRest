 ...
 * @author Nam_Nguyen
 */
@WebServlet(name = "editOrderDetail", urlPatterns = {"/editOrderDetail"})
public class editOrderDetail extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        od.setQuantity(quant);
        orderDetailsFacade.edit(od);
    }
